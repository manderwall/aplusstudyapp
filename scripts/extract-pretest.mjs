...
// ─── Match to the active deck and fill in ────────────────────
// Pass --deck=<path> to target a non-default deck (e.g. a future Core 3).
const deckArg = process.argv.find(a => a.startsWith('--deck='));
const dataPath = deckArg ? deckArg.slice(7) : 'data/core2/questions.json';
