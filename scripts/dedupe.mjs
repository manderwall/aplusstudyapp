#!/usr/bin/env node
// Dedupe data/core2/questions.json: merge repeated questions into a single card.
...
const DATA_PATH = process.argv[2] || 'data/core2/questions.json';
const src = JSON.parse(readFileSync(DATA_PATH, 'utf8'));
